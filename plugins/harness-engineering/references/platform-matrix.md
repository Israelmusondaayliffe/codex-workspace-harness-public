...
| Plugin install | `/plugin` UI, `claude plugin install`, marketplaces | Custom-plugin ZIP upload in **Customize** > **Plugins**, or a marketplace added from a repository | `codex plugin marketplace add`, `codex plugin add` |
